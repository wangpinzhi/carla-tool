...
class World(object):
    ...
    def restart(self):
        ...
        while self.player is None:
            ...
            # spawn_point = carla.Transform(carla.Location(9.60, -35.40, 0.5),carla.Rotation(0.0,0.0,0.0))
            spawn_point = carla.Transform(carla.Location(-18.93, -26.82, 0.5),carla.Rotation(0.0,-140.0,0.0))
            self.player = self.world.try_spawn_actor(blueprint, spawn_point)
            self.show_vehicle_telemetry = False
            self.modify_vehicle_physics(self.player)
        # Set up the sensors.
            ...
            if event.type == pygame.QUIT:
                ...
                if self._is_quit_shortcut(event.key):
                    ...
                    if world.constant_velocity_enabled:
                        self.save_flag = False
                        np.save('control_test.npy', self.controls_np)
                        ...
                        world.hud.notification("Enabled Constant Velocity Mode at 1 km/h")
                elif event.key == K_o:
                    try:
                    ...
                    if (world.recording_enabled):
                        ...
                        client.start_recorder("recorders/manual_recording.rec")
            ...
            if isinstance(self._control, carla.VehicleControl):
                ...
                if not self._ackermann_enabled:
                    ...
                    if self.save_flag:
                        ...
                        if self.controls_np is None:
                            self.controls_np = control_np
                        else:
                            self.controls_np = np.vstack([self.controls_np, control_np])
