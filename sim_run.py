...
if __name__ == '__main__':
    ...
    local_val_simulator_manager = ClassSimulatorManager(
        parameter_host='127.0.0.1',
        parameter_port=2000,
        parameter_path_sensor=r'output\huawei_parking18\configs\sensor_config.json',
        parameter_path_scene=r'output\huawei_parking18\configs\scene_config.json',
        parameter_path_save=r'output\huawei_parking18\raw_data',
    )
